...
import '../styles/AcademicRegistration.css';
...
const AcademicRegistration = () => {
  ...
  return (
    <Container maxWidth="lg" className="academic-container">
      <Typography variant="h4" className="academic-title">Academic Registration</Typography>
      <Typography className="academic-description">
        Register for your academic courses and view registration details.
      </Typography>
